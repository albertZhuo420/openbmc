...
SRC_URI:append:viscore-withhost = " file://set-bmc-time-from-host"


RDEPENDS:${PN}:append:viscore-withhost = " bash"

do_install:append:viscore-withhost(){
...
SYSTEMD_SERVICE:${PN}:viscore-withhost += "bmc-set-time.service"
