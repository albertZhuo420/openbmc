SUMMARY = "Viscore OEM IPMI commands"
DESCRIPTION = "Viscore OEM IPMI commands"
...
#    install -d ${D}${includedir}/fb-ipmi-oem
   install -d ${D}${includedir}/viscore-ipmi-oem
   install -m 0644 -D ${S}/include/*.hpp ${D}${includedir}/viscore-ipmi-oem
